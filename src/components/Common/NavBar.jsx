...
const NavBar = () => {
  ...
  return (
   <>
   <nav className='container mx-auto flex item-centers justify-between py-4 px-6'>
    <div>
  ...
  className='relative hover:text-black'>
    ...
    <span className='absolute -top-2 -right-2 bg-[#ea2e0e] text-white text-xs rounded-full px-2 py-0.5'>
      4
    </span>
     </button>
   ...
   <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-white shadow-lg
    transform transition-transform duration-300 z-50 ${navDrawerOpen?"translate-x-0" :
      "-translate-x-full"
    }`}
    >
